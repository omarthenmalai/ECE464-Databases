...
insert into boats values (101,'Interlake','blue', 45, 100, 20);
insert into boats values (102,'Interlake','red', 45, 105, 20);
insert into boats values (103,'Clipper','green', 40, 90, 10);
insert into boats values (104,'Clipper','red', 40, 95, 10);
insert into boats values (105,'Marine','red', 35, 85, 15);
insert into boats values (106,'Marine','green', 35, 85, 15);
insert into boats values (107,'Marine','blue', 35, 85, 15);
insert into boats values (108,'Driftwood','red', 35, 150, 30);
insert into boats values (109,'Driftwood','blue', 35, 150, 30);
insert into boats values (110,'Klapser','red', 30, 200, 50);
insert into boats values (111,'Sooney','gren', 28, 250, 80);
insert into boats values (112,'Sooney','red', 28, 255, 60);